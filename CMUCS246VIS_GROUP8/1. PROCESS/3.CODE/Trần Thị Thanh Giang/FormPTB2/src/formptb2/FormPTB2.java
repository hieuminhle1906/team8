...
public class FormPTB2 extends javax.swing.JFrame{
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (delta > 0) {
            ...
            lblResult.setText(a+"x^2"+b+"x"+c+"= 0 "+"   Phep tinh ca 2 bien: x1 = " + x1 + ", x2 = " + x2);
        } else if (delta == 0) {
            double x = -b / (2 * a);
            lblResult.setText(a+"x^2"+b+"x"+c+"= 0 "+"    Phep tinh ca 2 bien:x = " + x);
        } else {
            lblResult.setText("phep tinh va bien");
        }
